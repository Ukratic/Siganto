...
def get_fra_lib():
    ...
    fra_lib = {
        ...
        "group_const": "Groupe: Spectrogramme, Constellation, Spectre de puissance maximum",
        "spec_const": "Spectrogramme, Constellation, Spectre de puissance maximum",
        "spec_3d": "Spectrogramme 3D",
        "display": "Affichage et Options",
        ...
        "diff_freq": "Fréquence instantanée",
        ...
        "estim_speed": "Estimation de rapidité de modulation :",
        ...
        "dsp_max" : "Spectre de puissance maximum",
        ...
        "auto_center_coarse" : "Correction automatique (recherche de pics)",
        "auto_center_fine" : "Correction automatique (estimation de phase)",
        ...
        "scf" : "Fonction de corrélation spectrale (TSM)",
        ...
        "v_high_confidence" : "Confiance très élevée",
        ...
        "filter_order": "Ordre du filtre Butterworth pour passe-haut/bas et passe-bande [int]",
        ...
        "eye_diagram_params": "Paramètres du diagramme de l'oeil. Canal ['I' ou 'Q'], nombre de traces [int] et symboles par trace [int]",
        "mfsk_tone_detection_params": "Paramètres de démodulation MFSK basée sur la détection des tons :",
        "mfsk_tresh_db": "Seuil en dB [float]",
        "mfsk_peak_prom_db": "Proéminence des pics en dB [float]",
        "mfsk_win_factor": "Facteur de taille de fenêtre (multiple de Fe/Bauds) [float]",
...
def get_eng_lib():
    ...
    eng_lib = {
        ...
        "group_const": "Group: Spectrogram, Constellation, Peak Power Spectrum",
        "spec_const": "Spectrogram, Constellation, Peak Power Spectrum",
        "spec_3d": "3D Spectrogram",
        "display": "Display and Settings",
        ...
        "diff_freq": "Instantaneous Frequency",
        ...
        "estim_speed": "Symbol rate estimation :",
        "bandwidth": "Bandwidth",
        ...
        "auto_center_coarse" : "Automatic offset correction (peak-based)",
        "auto_center_fine" : "Automatic offset correction (phase-based)",
        ...
        "scf" : "Spectral Correlation Function (TSM)",
        "cyclic_f" : "Cyclic frequency",
        "low_confidence" : "Low confidence",
        "medium_confidence" : "Medium confidence",
        "high_confidence" : "High confidence",
        "v_high_confidence" : "Very high confidence",
        ...
        "filter_order": "Butterworth filter order for high/low pass and band pass [int]",
        ...
        "eye_diagram_params": "Eye diagram parameters. Channel ['I' or 'Q'], number of traces [int] and symbols per trace [int]",
        "mfsk_tone_detection_params": "Parameters for MFSK demodulation based on tone detection :",
        "mfsk_tresh_db": "Threshold in dB for MFSK demodulation [float]",
        "mfsk_peak_prom_db": "Peak prominence in dB for MFSK demodulation [float]",
        "mfsk_win_factor": "Window size factor for MFSK demodulation (multiple of Fs/Bauds) [float]",
