...
def get_fra_lib():
    ...
    fra_lib = {
        ...
        "demod_speed" : "Rapidité de modulation. Entrer 0 pour démodulation aveugle",
        ...
        "demod_mfsk": "Expérimental : Démodulation MFSK",
...
def get_eng_lib():
    ...
    eng_lib = {
        ...
        "param_order2" : "2-ary",
        "param_order4" : "4-ary",
        "demod_speed" : "Symbol rate. Enter 0 for blind demodulation",
        ...
        "demod_mfsk": "Experimental : MFSK Demodulation",
